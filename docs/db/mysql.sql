...
(
    ...
    `file_name`           varchar(100)  NOT NULL DEFAULT '' COMMENT '配置文件名称',
    `server_name`         varchar(100)  NOT NULL DEFAULT '' COMMENT '网站域名',
    `root_directory`      varchar(200)  NOT NULL DEFAULT '' COMMENT '网站根目录',
    `home_page`           varchar(200)  NOT NULL DEFAULT '' COMMENT '网站主页',
    ...
    `ssl_certificate`     varchar(200)  NOT NULL DEFAULT '' COMMENT 'TLS 证书路径',
    `ssl_certificate_key` varchar(200)  NOT NULL DEFAULT '' COMMENT '私钥路径',
    `status`              int(11) NOT NULL DEFAULT '0' COMMENT '启用状态 1: 正常 0:禁用',
    `content`             varchar(2048) NOT NULL DEFAULT '' COMMENT '配置文件内容',
    `create_time`         varchar(50)   NOT NULL COMMENT '创建时间',
    `update_time`         varchar(50)            DEFAULT NULL COMMENT '更新时间',
